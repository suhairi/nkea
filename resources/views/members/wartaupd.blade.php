    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-primary">
                <div class="panel-heading"><strong>KEMASKINI MAKLUMAT WARTA KERAJAAN</strong></div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                    <!-- <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
                                        ...
                                        <!-- <tr><td><br></td></tr>
                                        <tr>
                                                <td style="width: 100px">{{Form::Submit('Kemaskini',['class'=>'btn btn-primary'])}}</td>
                                                <td style="width: 50px"><a class="btn btn-primary" href="{{ url ('/warta') }}">Kembali</a></td>
                                        </tr>
                                    </table>
