    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-primary">
                <div class="panel-heading"><strong>Borang H (Menu)</strong></div>
                            ...
                            <div class="form-group">
                                <table width="900" border="0">
                                    <tr>
                                        ...
                                        <td style="width: 100px"><a class="btn btn-success" href="{{ url ('/borangh') }}">
                                        ...
                                        <tbody>
                                            <thead>
                                                ...
                                                <tr>
                                                    ...
                                                    <th width="30"><center>Nama</th>
                                                    <th width="10"><center>No. Kad Pengenalan</th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 50px">{{ $user->no_kp }}</td>
